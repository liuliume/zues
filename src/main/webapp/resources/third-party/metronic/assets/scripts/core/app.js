...
var App = function () {
    ...
    // Handles the message for toastr
    var handleMessages = function() {
		...
		if($("#info-message").text() != ""){
			toastr.info($("#info-message").text());
		}
		
		if($("#warning-message").text() != ""){
			toastr.warning($("#warning-message").text());
		}
		...
		if($.cookie('action-message') != undefined){
			$.cookie.json = true;
			var actionMessage = $.cookie('action-message');
			var action = actionMessage.action;
			var message = actionMessage.message;
