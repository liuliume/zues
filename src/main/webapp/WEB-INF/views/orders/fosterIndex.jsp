...
<body>
			...
			<form class="form-horizontal form-row-seperated" action="#"
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-calendar"></i>创建/编辑订单
						</div>
					</div>
						...
						<div class="tabbable">
							<div class="tab-content no-space">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-2 control-label">寄养开始日期: <span
											class="required"> * </span>
										</label>
										<div class="col-md-3">
											<input type="text" class="form-control" id="startDate"
												...
												class="help-block display-hide" id="errorInfoStartDate">请选择寄养开始日期!</span>
										</div>
									</div>

									<div class="form-group">
										<label class="col-md-2 control-label">寄养结束日期: <span
											class="required"> * </span>
										</label>
										<div class="col-md-3">
											<input type="text" class="form-control" id="endDate"
												name="endDate" value="${orders.endDate}" readonly="readonly">
											<span class="help-block display-hide" id="errorInfoEndDate">请选择寄养结束日期!</span>
										</div>
									</div>

									<div class="form-group">
										<label class="col-md-2 control-label">寄养房间: <span
											class="required"> * </span>
										</label>
										<div class="col-md-10">
											<select
												...
												<c:forEach items="${allRooms }" var="item">
													<option value="${item.id}"
														<c:choose>
															...
															<c:otherwise>
																<c:if test='${item.id eq orders.roomId}'>selected</c:if>
															</c:otherwise>
														</c:choose>>
														${item.roomName }</option>
												</c:forEach>
											</select> <span class="help-block display-hide" id="errorInfoRoom">请选择寄养房间日期!</span>
										</div>
									</div>
	...
	<script src="${ctx}/resources/scripts/pages/orders/fosterIndex.js"
