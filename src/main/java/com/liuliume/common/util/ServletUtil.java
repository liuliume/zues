...
public class ServletUtil {
    ...
    public static void setCookie(HttpServletRequest request,HttpServletResponse response, String key, String value, int second, String domain) {
        saveCookie(request,response, key, value, second, "/", domain);
    }

    public static void setCookie(HttpServletRequest request,HttpServletResponse response, String key, String value, int second) {
        saveCookie(request,response, key, value, second, "/");
    }
    ...
    public static void saveCookie(HttpServletRequest request,HttpServletResponse response, String key, String value,
        ...
        saveCookie(request,response, key, value, second, path, defaultDomain);
    }
